...
BENCHMARK_MATRIX: dict[str, list[dict]] = {
    "CODE_GEN": [
        ...
        {"provider": "groq", "model": "openai/gpt-oss-120b", "key_id": "groq_key1", "rank": 2},
        {"provider": "gemini", "model": "gemini-2.5-flash", "key_id": "gemini_key_code1", "rank": 3},
    ],
    "CREATIVE_TEXT": [
        {"provider": "mistral", "model": "mistral-large-latest", "key_id": "mistral_key1", "rank": 1},
        {"provider": "gemini", "model": "gemini-2.5-flash", "key_id": "gemini_key1", "rank": 2},
    ...
    "MATH_LOGIC": [
        ...
        {"provider": "gemini", "model": "gemini-2.5-flash", "key_id": "gemini_key2", "rank": 2},
        {"provider": "mistral", "model": "mistral-medium-latest", "key_id": "mistral_key2", "rank": 3},
    ],
    "DOC_SUMMARIZATION": [
        {"provider": "gemini", "model": "gemini-2.5-flash", "key_id": "gemini_key3", "rank": 1},
